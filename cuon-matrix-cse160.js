...
class Vector3 {
    ...
    /**
      * @param Subtract other from this vector.
      * @return this
      */
    sub(other) {
        // Insert your code here.
    ...
    /**
      * @param Divide this vector by a scalar.
      * @return this
      */
    div(scalar) {
        // Insert your code here.
    ...
    static dot(other1, other2) {
        // Insert your code here.
        const d1 = other1.elements;
        const d2 = other2.elements;
    ...
    static cross(other1, other2) {
        ...
        const x = d1[1] * d2[2] - d1[2] * d2[1];
        const y = d1[2] * d2[0] - d1[0] * d2[2];
        const z = d1[0] * d2[1] - d1[1] * d2[0];
    ...
    magnitude() {
        // Insert your code here.
        let m = this.elements; // Modify this line to calculate this vector's magnitude.
        // Don't delete the return statement.
    ...
    normalize() {
        ...
        if (mag === 0) {
            console.error("Cannot normalize a vector with magnitude 0.");
            return this;
        }
        return this.div(mag);
    };
